...
{
    /// <inheritdoc />
    public partial class AddImageUrlToTournaments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GamingStations_Shops_ShopId",
                        column: x => x.ShopId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tournaments_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PlaySessions_GamingStations_GamingStationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_GamingStations_GamingStationId",
                        column: x => x.GamingStationId,
                        principalTable: "GamingStations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GamingStations_ShopId",
                table: "GamingStations",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_PlaySessions_GamingStationId",
                table: "PlaySessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_GamingStationId",
                table: "Reservations",
                column: "GamingStationId");
